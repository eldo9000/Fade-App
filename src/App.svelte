<script>
  ...
  // Chroma Key state is now owned by ChromaKeyPanel.svelte
  // Analysis state is now owned by AnalysisTools.svelte
  ...
  // Analysis functions are now owned by AnalysisTools.svelte
  ...
  // Chroma Key functions are now owned by ChromaKeyPanel.svelte
