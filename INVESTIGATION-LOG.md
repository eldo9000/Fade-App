...
2026-05-05 | OPEN | dispatch 1/3 — SESSION-STATUS Known Risks line 50 carries stale "no unit tests for path logic (TASK-29)" forward-reference; tests landed in 555e602 (args/model_blender.rs + convert/model_blender.rs) and 851b55d (cargo fmt); doc was not updated when work landed.
2026-05-05 | CONFIRMED | dispatch 1/3 — TASK-29 stale forward-reference cleared from SESSION-STATUS Known Risks; `Last updated:` line bumped to 2026-05-05; genuine "no Blender version check (deferred)" gap retained; commit db4c157.
